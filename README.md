...
не має авторизації: будь-хто, хто знає адресу медіасервера, може переглянути й
завантажити відео, запустити або зупинити трансляцію. Локально та за замовчуванням
медіасервер слухає лише `127.0.0.1`. У продакшн-конфігурації (`compose.yaml`) порт
`8788` навмисно відкритий у публічний інтернет, бо браузер клієнта звертається до
нього напряму — усвідомлюйте цей ризик, поки немає авторизації чи reverse proxy.
